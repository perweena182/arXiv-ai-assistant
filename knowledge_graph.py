...
class RAG_Graph:
    ...
    def __init__(self):
        ...
        self.llm = ChatGroq(temperature = 0.5,groq_api_key="<groq-api-key>",model_name="llama3-70b-8192")
    
    def create_graph(self,document):
        # for source_docs in docs:TMP_DIR
    ...
    def create_vector_index(self):
        ...
        # embedding_dimension = 768 if model_name == 'sentence-transformers/all-mpnet-base-v2' else 384
